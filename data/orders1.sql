...
CREATE TABLE `orders1` (
  ...
  `receiver-mobile` varchar(255) NOT NULL,
...
INSERT INTO `orders1` (`sid`, `mid`, `amount`, `receiver`, `receiver-mobile`, `address`, `order_date`, `order_state`, `designated_date`, `designated_period`, `deliver_state`, `payment_type`) VALUES
