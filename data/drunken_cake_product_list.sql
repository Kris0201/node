...
--
-- 資料表結構 `drunken_cake_product_list`
--

CREATE TABLE `drunken_cake_product_list` (
...
--
-- 傾印資料表的資料 `drunken_cake_product_list`
--

INSERT INTO `drunken_cake_product_list` (`p_sid`, `p_name`, `p_cate`, `p_size`, `p_price`, `p_intro`, `p_img`, `p_carousel_img`, `p_desc`, `Alcohol_vol`, `ingredient`, `cake`, `m_v`, `storage`, `expir`, `member_id`) VALUES
...
(20, '老虎', 0, NULL, 400, NULL, '下載.png', '', '呵呵', 0, '', '千層蛋糕體', '奶蛋素', '冷藏', '冷藏1~2天內食用完畢，實際保存期限請見包裝標示', ''),
...
--
-- 資料表索引 `drunken_cake_product_list`
--
ALTER TABLE `drunken_cake_product_list`
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `drunken_cake_product_list`
--
ALTER TABLE `drunken_cake_product_list`
